...
<div class="row">
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-xs-10">
					<input type="text" class="form-control" id="no_ktp" placeholder="Nomor KTP">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-xs-10">
					<input type="text" class="form-control" id="kontrak_mulai" placeholder="Tanggal Kontrak Mulai">
				</div>
			</div>
                        <div class="form-group">
				<label for="kontrak_berakhir" class="col-xs-2 control-label">Kontrak Berakhir</label>
				<div class="col-xs-10">
					<input type="text" class="form-control" id="kontrak_berakhir" placeholder="Tanggal Kontrak Berakhir">
				</div>
			</div>
                        <div class="form-group">
				<label for="gp_awal" class="col-xs-2 control-label">GP Awal</label>
				<div class="col-xs-10">
					<input type="text" class="form-control" id="gp_awal" placeholder="GP Awal">
				</div>
			</div>
                        <div class="form-group">
				<label for="no_absen" class="col-xs-2 control-label">No Absen</label>
				<div class="col-xs-10">
					<input type="text" class="form-control" id="no_absen" placeholder="No Absen">
				</div>
			</div>
                        <div class="form-group">
